    ...
    public static class StartingUserInterface
    {
        ...
        public static void CreateCommand(string command)
        {
            ...
            switch (type)
            {
                ...
                case "ranked":
                    ...
                    break;
                default:
                    Console.WriteLine($"The value entered ,{type} is not a supported type of gradebook, please try again");
                    return;
            }
        ...
        public static void HelpCommand()
        {
            ...
            Console.WriteLine("Create 'Name' 'Type' 'Weighted' - Creates a new gradebook where 'Name' " +
                              "is the name of the gradebook, 'Type' is what type of grading it should use, " +
